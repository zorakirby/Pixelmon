...
public class ModelGloom extends ModelBase
{
  ...
  public ModelGloom()
  {
    textureWidth = 64;
    textureHeight = 127;
    setTextureOffset("LEFTLEG.delete", 0, 0);
    setTextureOffset("RIGHTLEG.delete2", 0, 0);
    setTextureOffset("BODYBASE.Delete3", 0, 0);
    setTextureOffset("LEFTARM.DELETE", 0, 0);
    setTextureOffset("RIGHTARM.DELETE", 0, 0);
    ...
    LEFTARM.mirror = true;
      ...
      LeftArm.setRotationPoint(0.5F, 0F, 0F);
    ...
    RIGHTARM.mirror = true;
      ...
      RightArm.setRotationPoint(-0.5F, 0F, 0F);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
  {
    ...
    LEFTARM.rotateAngleY = MathHelper.cos(f * 0.7F) * 1F * f1;
    RIGHTARM.rotateAngleY = MathHelper.cos(f * 0.7F) *1F * f1;
  }
