...
public class KoffingParticles extends ParticleEffects {
	...
	public void onUpdate() {
		...
		count--;
		if (particlesOn)
			ClientProxy.spawnParticle(EnumPixelmonParticles.koffing, pixelmon.worldObj, pixelmon.posX + (double) var6, pixelmon.posY + pixelmon.hoverTimer + 1.5F, pixelmon.posZ + (double) var7);
