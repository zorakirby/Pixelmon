...
public enum EnumStatusAilmentHealers {
	FullRestore(66, "all", true, "fullrestore", 64), Antidote(82, "Poison", false, "antidote", 80),
	ParlyzHeal(98, "Paralysis", false, "parlyzheal", 96), Awakening(114, "Sleep", false, "awakening", 112),
	BurnHeal(130, "Burn", false, "burn", 128), IceHeal(146, "Freeze", false, "iceheal", 144),
	FullHeal(162, "all", false, "fullheal", 160);

	private EnumStatusAilmentHealers(int index, String status, boolean healsHP, String filenamePrefix,
			int iconIndex) {
		String[] statuses = {};
		if (status.equalsIgnoreCase("all")){
			statuses = new String[] {"Burn", "Confusion", "Freeze", "Paralysis", "Poison", "Sleep"};
		} else {
