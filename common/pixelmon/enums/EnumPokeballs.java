...
public enum EnumPokeballs {
	...
	GreatBall(1, 1.5, "greatball", 0, 1, 4, 2, 4, 3, new EnumApricorns[]{EnumApricorns.Blue, EnumApricorns.Red, EnumApricorns.Blue}, 2, 25),
	UltraBall(2, 2, "ultraball", 0, 2, 5, 2, 5, 3, new EnumApricorns[]{EnumApricorns.Black, EnumApricorns.Yellow, EnumApricorns.Black}, 1, 35),
	MasterBall(3, 255, "masterball", 0, 3, 0, 0, 0, 0, null, 0, 1000),
	...
	//TODO Add lure, cherish and premier balls. 
