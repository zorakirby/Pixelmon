...
public class WorldManager implements IWorldAccess
{
    ...
    {
        this.world.getEntityTracker().addEntityToTracker(par1Entity);
    }
    ...
    {
        this.world.getEntityTracker().removeEntityFromAllTrackingPlayers(par1Entity);
    }
    ...
    {
        this.mcServer.getConfigurationManager().sendToAllNear(par2, par4, par6, par8 > 1.0F ? (double)(16.0F * par8) : 16.0D, this.world.provider.worldType, new Packet62LevelSound(par1Str, par2, par4, par6, par8, par9));
    }
    ...
    {
        this.world.getPlayerManager().flagChunkForUpdate(par1, par2, par3);
    }
    ...
    {
        this.mcServer.getConfigurationManager().sendToAllNearExcept(par1EntityPlayer, (double)par3, (double)par4, (double)par5, 64.0D, this.world.provider.worldType, new Packet61DoorChange(par2, par3, par4, par5, par6));
    }
