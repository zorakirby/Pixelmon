...
import pixelmon.Pokemon.EntityCubone;
...
import pixelmon.Pokemon.EntityKakuna;
...
import pixelmon.Pokemon.EntityPrimeape;
...
import pixelmon.Pokemon.EntityShellder;
...
import pixelmon.Pokemon.EntityWeezing;
...
public class PixelmonEntityList {
	...
	static {
		...
		addMapping(EntityKakuna.class, "Kakuna", IDListPixelmon.kakunaId, ClassType.Pixelmon);
		addMapping(EntityKoffing.class, "Koffing", IDListPixelmon.koffingId, ClassType.Pixelmon);
		addMapping(EntityWeezing.class, "Weezing", IDListPixelmon.weezingId, ClassType.Pixelmon);
		addMapping(EntityPrimeape.class, "Primeape", IDListPixelmon.primeapeId, ClassType.Pixelmon);
