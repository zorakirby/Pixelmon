...
public class mod_Pixelmon extends NetworkMod {
	...
	public static final Item pokeBall = new ItemEmptyPokeBall(10000, EnumPokeballs.PokeBall).setItemName("PokeBall").setIconIndex(pIMG);
	public static final Item greatBall = new ItemEmptyPokeBall(10001, EnumPokeballs.GreatBall).setItemName("GreatBall").setIconIndex(gIMG);
	public static final Item ultraBall = new ItemEmptyPokeBall(10002, EnumPokeballs.UltraBall).setItemName("UltraBall").setIconIndex(uIMG);
	public static final Item masterBall = new ItemEmptyPokeBall(10003, EnumPokeballs.MasterBall).setItemName("MasterBall").setIconIndex(mIMG);
