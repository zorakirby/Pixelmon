...
//		}
		hasGenerated = true;
		SchematicImporter s = new SchematicImporter("resources/pixelmon/structures/basicTown/house.schematic");
		s.readSchematic();
		GeneralScattered g = new GeneralScattered(random, xPos, yPos, zPos, s);
		hasGenerated = g.generate(world, random);
		System.out.println("A structure has Generated at: " + xPos + ", " + yPos + ", " + zPos);
	}
}
