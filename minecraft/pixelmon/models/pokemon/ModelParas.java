...
public class ModelParas extends ModelBase
{
  ...
  public ModelParas()
  {
    ...
    textureHeight = 32;
      ...
      claw2.setRotationPoint(5F, 21.7F, -0.1F);
      claw2.setTextureSize(64, 32);
      claw2.mirror = true;
      setRotation(claw2, 0F, -0.6676583F, -2.379634F);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
  {
    super.setRotationAngles(f, f1, f2, f3, f4, f5);
  	Leg_part4.rotateAngleX = MathHelper.cos(f * 1.4F) * 1F * f1;
  	Leg_part10.rotateAngleX = MathHelper.cos(f * 1.4F + 3.141593F) * 1F * f1;
  	Leg_part6.rotateAngleX = MathHelper.cos(f * 1.4F + 3.141593F) * 1F * f1;
  	Leg_part8.rotateAngleX = MathHelper.cos(f * 1.4F) * 1F * f1;
  }
