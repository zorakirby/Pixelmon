...
public class ModelArbok extends ModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3,
		...
		Segment3.rotateAngleY = ((float) Math.pow(dampingFactor, -5))
				* TopAngle
				* (MathHelper.cos(animationSpeed * f + initialOffset));
		currentAngle = Segment3.rotateAngleY;
		Segment4.rotateAngleY = ((float) Math.pow(dampingFactor, 2))
				* TopAngle
		...
		Segment5.rotateAngleY = ((float) Math.pow(dampingFactor, 3))
				* TopAngle
				* (MathHelper.cos(animationSpeed * f + 1.1f * 2 * offset + PI
						/ 9 + initialOffset)) - currentAngle;
		currentAngle = Segment3.rotateAngleY + Segment4.rotateAngleY
				+ Segment5.rotateAngleY;
		Segment6.rotateAngleY = ((float) Math.pow(dampingFactor, 5))
				* TopAngle
				* (MathHelper.cos(animationSpeed * f + 1.2f * 3 * offset + 2
						* PI / 9 + initialOffset)) - currentAngle;// -PI/6;
		currentAngle = Segment3.rotateAngleY + Segment4.rotateAngleY
				+ Segment5.rotateAngleY + Segment6.rotateAngleY;
		Segment7.rotateAngleY = ((float) Math.pow(dampingFactor, 6))
				* TopAngle
		...
		Segment8.rotateAngleY = ((float) Math.pow(dampingFactor, 7))
				* TopAngle
		...
		Segment9.rotateAngleY = ((float) Math.pow(dampingFactor, 6))
				* TopAngle
