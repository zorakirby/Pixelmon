...
import pixelmon.blocks.TileEntityApricornTreeSprout;
import net.minecraft.src.Entity;
import net.minecraft.src.ModelBase;
import net.minecraft.src.ModelRenderer;

public class ModelApricornTreeSprout extends ModelBase
{
  //fields
    ModelRenderer Base;
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
	...
	public void renderModel(TileEntityApricornTreeSprout entity, float f5) {
	    Base.render(f5);
	    BaseLeft.render(f5);
	    BaseBack.render(f5);
	    BaseRight.render(f5);
