...
public class ModelPokeball extends ModelBase
{
  ...
  public ModelPokeball()
  {
    ...
    Hinge.mirror = true;
      ...
      WhiteBack.setRotationPoint(0F, 0F, -1.5F);
      ...
      WhiteLeft.setRotationPoint(0F, 0F, -1.5F);
      ...
      WhiteFront.setRotationPoint(0F, 0F, -1.5F);
      ...
      WhiteTop.setRotationPoint(0F, 0F, -1.5F);
      ...
      WhiteBottom.setRotationPoint(0F, 0F, -1.5F);
      ...
      WhiteRight.setRotationPoint(0F, 0F, -1.5F);
      ...
      WhteTip.setRotationPoint(0F, 0F, -1.5F);
      WhteTip.setTextureSize(32, 32);
      WhteTip.mirror = true;
      setRotation(WhteTip, 0F, 0F, 0F);
      
      
        Rocking.addChild(Hinge);
		...
		Hinge.addChild(WhteTip);
		Hinge.addChild(WhiteTop);
		Hinge.addChild(WhiteBottom);
		Hinge.addChild(WhiteFront);
		Hinge.addChild(WhiteBack);
		Hinge.addChild(WhiteRight);
		Hinge.addChild(WhiteLeft);
		Hinge.addChild(Button);
  }
