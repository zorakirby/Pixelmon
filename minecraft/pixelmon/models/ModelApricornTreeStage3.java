...
import pixelmon.blocks.TileEntityApricornTreeStage3;
import net.minecraft.src.Entity;
import net.minecraft.src.ModelBase;
import net.minecraft.src.ModelRenderer;

public class ModelApricornTreeStage3 extends ModelBase
{
  //fields
    ModelRenderer Base;
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
	...
	public void renderModel(TileEntityApricornTreeStage3 entity, float f5) {
	    Base.render(f5);
	    RootFront.render(f5);
	    RootBack.render(f5);
	    RootRight.render(f5);
