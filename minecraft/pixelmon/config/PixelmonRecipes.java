...
public class PixelmonRecipes {
	...
	public static void addRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(PixelmonItems.newRunningShoes, 1), new Object[] { "DBD", "I I", "F F", Character.valueOf('I'), Item.ingotIron, Character.valueOf('D'), Item.diamond, Character.valueOf('F'), Item.feather, Character.valueOf('B'), PixelmonItems.oldRunningShoes});
		GameRegistry.addRecipe(new ItemStack(PixelmonItems.oldRunningShoes, 1), new Object[] { "IBI", "I I", "F F", Character.valueOf('I'), Item.ingotIron, Character.valueOf('F'), Item.feather, Character.valueOf('B'), Item.bootsLeather});
