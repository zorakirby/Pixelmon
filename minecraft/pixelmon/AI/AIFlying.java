...
//            if (currentFlightTarget != null && (!pixelmon.worldObj.isAirBlock(currentFlightTarget.posX, currentFlightTarget.posY, currentFlightTarget.posZ) || currentFlightTarget.posY < 1))
//            {
//                currentFlightTarget = null;
//            }
//
//            // finding a new target, randomly
//            if (currentFlightTarget == null || rand.nextInt(30) == 0 || currentFlightTarget.getDistanceSquared((int) pixelmon.posX, (int) pixelmon.posY, (int) pixelmon.posZ) < 4.0F)
//            {
...
//        }
//        else {
//        	if (this.currentFlightTarget != null && (!pixelmon.worldObj.isAirBlock(this.currentFlightTarget.posX, this.currentFlightTarget.posY, this.currentFlightTarget.posZ) || this.currentFlightTarget.posY < 1))
//        {
//            this.currentFlightTarget = null;
//        }
//
//        if (this.currentFlightTarget == null || this.rand.nextInt(30) == 0 || this.currentFlightTarget.getDistanceSquared((int)pixelmon.posX, (int)pixelmon.posY, (int)pixelmon.posZ) < 4.0F)
//        {
//            this.currentFlightTarget = new ChunkCoordinates((int)pixelmon.posX + this.rand.nextInt(7) - this.rand.nextInt(7), (int)pixelmon.posY + this.rand.nextInt(6) - 2, (int)pixelmon.posZ + this.rand.nextInt(7) - this.rand.nextInt(7));
//        }
//        double d0;
//        double d1;
//        double d2;
...
//        if (this.rand.nextInt(100) == 0 && pixelmon.worldObj.isBlockNormalCube(MathHelper.floor_double(pixelmon.posX), (int)pixelmon.posY + 1, MathHelper.floor_double(pixelmon.posZ)))
//        {
...
//    {
//        
//        if (pixelmon.getOwner() != null && pixelmon.getOwner().isEntityAlive() &&  pixelmon.getDistanceSqToEntity(pixelmon.getOwner()) > OWNER_DISTANCE_TO_TAKEOFF)
//        {
//            takeOff();
//        }
//        
