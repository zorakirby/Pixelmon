...
public class ModelKabuto extends ModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		LegFL.rotateAngleY = MathHelper.cos(f * 2F + (float) Math.PI) * f1 * .8F;
		LegBL.rotateAngleY = MathHelper.cos(f * 2F) * f1 * .8F;
		LegFR.rotateAngleY = MathHelper.cos(f * 2F) * f1 * .8F;
		LegBR.rotateAngleY = MathHelper.cos(f * 2F + (float) Math.PI) * f1 * .8F;
		LegFL.rotateAngleZ = MathHelper.sin(f * 2F + (float) Math.PI) * f1 * .5F;
		LegBL.rotateAngleZ = MathHelper.sin(f * 2F) * f1 * .5F;
		LegFR.rotateAngleZ = MathHelper.sin(f * 2F) * f1 * .5F;
		LegBR.rotateAngleZ = MathHelper.sin(f * 2F + (float) Math.PI) * f1 * .5F;
	}
