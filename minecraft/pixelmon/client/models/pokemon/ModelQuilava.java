...
public class ModelQuilava extends PixelmonModelBase {
	...
	public ModelQuilava() {
		...
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader
				.loadModel("/pixelmon/client/models/objFiles/quilava/Body.obj")));
		head = new PixelmonModelRenderer(this, 0, 0);
		head.setRotationPoint(0F, 2.739F, 2.261F);
		head.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader
				.loadModel("/pixelmon/client/models/objFiles/quilava/Head.obj")));
		footFL = new PixelmonModelRenderer(this, 0, 0);
		footFL.setRotationPoint(0.47F, 2.462F, 1.9F);
		footFL.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/quilava/FrontLeftLeg.obj")));
		footFR = new PixelmonModelRenderer(this, 0, 0);
		footFR.setRotationPoint(-0.47F, 2.462F, 1.9F);
		footFR.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/quilava/FrontRightLeg.obj")));
		footBL = new PixelmonModelRenderer(this, 0, 0);
		footBL.setRotationPoint(0.693F, 1.433F, -1.72F);
		footBL.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/quilava/BackLeftLeg.obj")));
		footBR = new PixelmonModelRenderer(this, 0, 0);
		footBR.setRotationPoint(-0.693F, 1.433F, -1.72F);
		footBR.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/quilava/BackRightLeg.obj")));
		...
		skeleton = new SkeletonQuadruped(Body, headModule, leftLegModule,
				rightLegModule, backLeft, backRight, null);
		scale = 3.2f;
	}
