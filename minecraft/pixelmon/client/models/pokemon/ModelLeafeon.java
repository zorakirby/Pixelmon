...
public class ModelLeafeon extends PixelmonModelBase
{
  //fields
  ...
  public ModelLeafeon()
  {
    ...
    Body.addChild(BRLeg);
      ...
      Tail.setRotationPoint(0, -2, 5);
      PixelmonModelRenderer tail_1 = new PixelmonModelRenderer(this, 42, 28);
      tail_1.addBox(-3F, -0.4666667F, -1F, 6, 1, 5);
      tail_1.setTextureSize(128, 64);
      tail_1.mirror = true;
      setRotation(tail_1, 0.5061455F, 0F, 0F);
      PixelmonModelRenderer tail_2 = new PixelmonModelRenderer(this, 36, 18);
      tail_2.addBox(-5F, -0.2F, 0F, 10, 1, 9);
      tail_2.setRotationPoint(0F, -2F, 3F);
      tail_2.setTextureSize(128, 64);
      tail_2.mirror = true;
      setRotation(tail_2, 0.8901179F, 0F, 0F);
      PixelmonModelRenderer tail_3 = new PixelmonModelRenderer(this, 38, 9);
      tail_3.addBox(-4F, -0.2666667F, -0.3333333F, 8, 1, 8);
      tail_3.setRotationPoint(0F, -9F, 8.8F);
      tail_3.setTextureSize(128, 64);
      tail_3.mirror = true;
      setRotation(tail_3, 0.5585054F, 0F, 0F);
      PixelmonModelRenderer tail_4 = new PixelmonModelRenderer(this, 39, 0);
      tail_4.addBox(-3.533333F, -0.3666667F, 0.4666667F, 7, 1, 8);
      tail_4.setRotationPoint(0F, -13F, 14.8F);
      ...
      PixelmonModelRenderer leg_leaf_b_L = new PixelmonModelRenderer(this, 22, 0);
      leg_leaf_b_L.addBox(0F, 5.533333F, -5.866667F, 1, 4, 2);
      leg_leaf_b_L.setTextureSize(128, 64);
      leg_leaf_b_L.mirror = true;
      setRotation(leg_leaf_b_L, 1.029744F, 0.3839724F, 0F);
      BLLeg.addChild(leg_leaf_b_L);
      
      
      PixelmonModelRenderer  leg_leaf_b_R = new PixelmonModelRenderer(this, 22, 0);
      leg_leaf_b_R.addBox(0F, 5.533333F, -5.866667F, 1, 4, 2);
      leg_leaf_b_R.setTextureSize(128, 64);
      leg_leaf_b_R.mirror = true;
      setRotation(leg_leaf_b_R, 1.029744F, -0.3839724F, 0F);
      BRLeg.addChild(leg_leaf_b_R);
      
      
      PixelmonModelRenderer leg_leaf_f_R = new PixelmonModelRenderer(this, 22, 0);
      leg_leaf_f_R.addBox(0F, 4.533333F, -5.866667F, 1, 4, 2);
      leg_leaf_f_R.setTextureSize(128, 64);
      leg_leaf_f_R.mirror = true;
      setRotation(leg_leaf_f_R, 1.029744F, -0.3839724F, 0F);
      PixelmonModelRenderer leg_leaf_f_R_2 = new PixelmonModelRenderer(this, 22, 0);
      leg_leaf_f_R_2.addBox(0F, 2.133333F, 4.266667F, 1, 4, 2);
      leg_leaf_f_R_2.setTextureSize(128, 64);
      leg_leaf_f_R_2.mirror = true;
      setRotation(leg_leaf_f_R_2, -0.9773844F, 0.7853982F, 0F);
      FRLeg.addChild(leg_leaf_f_R);
      FRLeg.addChild(leg_leaf_f_R_2);
      
      PixelmonModelRenderer leg_leaf_f_L = new PixelmonModelRenderer(this, 22, 0);
      leg_leaf_f_L.addBox(0F, 4.533333F, -5.866667F, 1, 4, 2);
      leg_leaf_f_L.setTextureSize(128, 64);
      leg_leaf_f_L.mirror = true;
      setRotation(leg_leaf_f_L, 1.029744F, 0.3839724F, 0F);
      PixelmonModelRenderer  leg_leaf_f_L_2 = new PixelmonModelRenderer(this, 22, 0);
      leg_leaf_f_L_2.addBox(0F, 2.133333F, 4.266667F, 1, 4, 2);
      leg_leaf_f_L_2.setTextureSize(128, 64);
      leg_leaf_f_L_2.mirror = true;
      setRotation(leg_leaf_f_L_2, -0.9773844F, -0.7853982F, 0F);
      FLLeg.addChild(leg_leaf_f_L);
      FLLeg.addChild(leg_leaf_f_L_2);
      
      
      PixelmonModelRenderer body_leaf = new PixelmonModelRenderer(this, 19, 7);
      body_leaf.addBox(-4F, -2F, -5F, 3, 1, 6);
      body_leaf.setTextureSize(128, 64);
      body_leaf.mirror = true;
      setRotation(body_leaf, 0.4712389F, -0.3316126F, 0.8028515F);
      PixelmonModelRenderer chest_leaves = new PixelmonModelRenderer(this, 27, 28);
      chest_leaves.addBox(3.8F, 5.666667F, -2.266667F, 1, 7, 6);
      chest_leaves.setTextureSize(128, 64);
      chest_leaves.mirror = true;
      setRotation(chest_leaves, -0.7504916F, 1.029744F, -0.4014257F);
      Body.addChild(body_leaf);
      Body.addChild(chest_leaves);
      
      
      
      PixelmonModelRenderer head_fur_tufts = new PixelmonModelRenderer(this, 0, 12);
      head_fur_tufts.addBox(-3.1F, -8F, -3.866667F, 7, 5, 1);
      head_fur_tufts.setTextureSize(128, 64);
      head_fur_tufts.mirror = true;
      setRotation(head_fur_tufts, -0.2094395F, 0F, 0F);
      PixelmonModelRenderer head_fur_tufts_center = new PixelmonModelRenderer(this, 0, 0);
      head_fur_tufts_center.addBox(-2.833333F, -12.8F, -3.866667F, 9, 10, 1);
      head_fur_tufts_center.setTextureSize(128, 64);
      head_fur_tufts_center.mirror = true;
      setRotation(head_fur_tufts_center, -0.122173F, 0.0523599F, 0F);
      Head.addChild(head_fur_tufts);
      Head.addChild(head_fur_tufts_center);
