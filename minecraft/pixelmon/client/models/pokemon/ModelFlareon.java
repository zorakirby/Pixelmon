...
public class ModelFlareon extends PixelmonModelBase {
	// fields
	...
	public ModelFlareon() {
		...
		PixelmonModelRenderer mane_1 = new PixelmonModelRenderer(this, 104, 52);
		mane_1.addBox(-4.5F, -0.4666667F, -6.066667F, 9, 8, 4);
		mane_1.setTextureSize(128, 64);
		mane_1.mirror = true;
		setRotation(mane_1, -0.5061455F, 0F, 0F);
		PixelmonModelRenderer mane_2 = new PixelmonModelRenderer(this, 104, 52);
		mane_2.addBox(-5F, 0F, -7F, 10, 7, 3);
		mane_2.setTextureSize(128, 64);
		mane_2.mirror = true;
		setRotation(mane_2, -0.5061455F, 0F, 0F);
		PixelmonModelRenderer mane_top = new PixelmonModelRenderer(this, 104, 52);
		mane_top.addBox(-4.5F, 0.8F, -7.333333F, 9, 6, 3);
		mane_top.setTextureSize(128, 64);
		mane_top.mirror = true;
		setRotation(mane_top, -0.6457718F, 0F, 0F);
		PixelmonModelRenderer mane_back = new PixelmonModelRenderer(this, 104, 52);
		mane_back.addBox(-3.5F, -1.533333F, -7.2F, 7, 4, 5);
		mane_back.setTextureSize(128, 64);
		mane_back.mirror = true;
		setRotation(mane_back, -0.3490659F, 0F, 0F);
		PixelmonModelRenderer mane_back_2 = new PixelmonModelRenderer(this, 104, 52);
		mane_back_2.addBox(-2.5F, -2.266667F, -7.133333F, 5, 4, 5);
		mane_back_2.setTextureSize(128, 64);
		mane_back_2.mirror = true;
		setRotation(mane_back_2, -0.3141593F, 0F, 0F);
		Body.addChild(mane_1);
		Body.addChild(mane_2);
		Body.addChild(mane_top);
		Body.addChild(mane_back);
		Body.addChild(mane_back_2);

		PixelmonModelRenderer head_fluff_main = new PixelmonModelRenderer(this, 111, 58);
		head_fluff_main.addBox(-1.5F, -5.866667F, -4.6F, 3, 3, 3);
		head_fluff_main.setTextureSize(128, 64);
		head_fluff_main.mirror = true;
		setRotation(head_fluff_main, 0.2094395F, 0F, 0F);
		PixelmonModelRenderer head_fluff_sides = new PixelmonModelRenderer(this, 111, 57);
		head_fluff_sides.addBox(-2F, -5.466667F, -4.2F, 4, 2, 2);
		head_fluff_sides.setTextureSize(128, 64);
		head_fluff_sides.mirror = true;
		setRotation(head_fluff_sides, 0.2094395F, 0F, 0F);
		PixelmonModelRenderer head_fluff_top = new PixelmonModelRenderer(this, 111, 55);
		head_fluff_top.addBox(-1F, -6.666667F, -3.6F, 2, 2, 3);
		head_fluff_top.setTextureSize(128, 64);
		head_fluff_top.mirror = true;
		setRotation(head_fluff_top, 0.3490659F, 0F, 0F);
		PixelmonModelRenderer head_fluff_swirl_ = new PixelmonModelRenderer(this, 27, 21);
		head_fluff_swirl_.addBox(1.2F, -5.6F, 0.1333333F, 4, 1, 5);
		head_fluff_swirl_.setTextureSize(128, 64);
		head_fluff_swirl_.mirror = true;
		setRotation(head_fluff_swirl_, 0.8901179F, 0.3665191F, -0.4014257F);
		Head.addChild(head_fluff_main);
		Head.addChild(head_fluff_sides);
		Head.addChild(head_fluff_top);
		Head.addChild(head_fluff_swirl_);

		PixelmonModelRenderer Tail = new PixelmonModelRenderer(this, "Tail");
		Tail.setRotationPoint(0, -1, 5);
		PixelmonModelRenderer tail_main = new PixelmonModelRenderer(this, 98, 49);
		tail_main.addBox(-4F, -3.066667F, 0F, 8, 8, 7);
		tail_main.setTextureSize(128, 64);
		tail_main.mirror = true;
		setRotation(tail_main, 0.7679449F, 0F, 0F);
		PixelmonModelRenderer tail_1 = new PixelmonModelRenderer(this, 106, 56);
		tail_1.addBox(-2.5F, -0.06666667F, -1F, 5, 3, 4);
		tail_1.setTextureSize(128, 64);
		tail_1.mirror = true;
		setRotation(tail_1, 0.0174533F, 0F, 0F);
		PixelmonModelRenderer tail_sides = new PixelmonModelRenderer(this, 98, 49);
		tail_sides.addBox(-4.866667F, -2.666667F, 0.4666667F, 10, 7, 6);
		tail_sides.setTextureSize(128, 64);
		tail_sides.mirror = true;
		setRotation(tail_sides, 0.7679449F, 0F, 0F);
		PixelmonModelRenderer tail_sides_2 = new PixelmonModelRenderer(this, 98, 48);
		tail_sides_2.addBox(-3.2F, -4.066667F, 0.4F, 7, 10, 6);
		tail_sides_2.setTextureSize(128, 64);
		tail_sides_2.mirror = true;
		setRotation(tail_sides_2, 0.7679449F, 0F, 0F);
		PixelmonModelRenderer tail_2 = new PixelmonModelRenderer(this, 98, 49);
		tail_2.addBox(-3.5F, -1.466667F, 3.466667F, 7, 7, 5);
		tail_2.setTextureSize(128, 64);
		tail_2.mirror = true;
		setRotation(tail_2, 1.064651F, 0F, 0F);
		PixelmonModelRenderer tail_3 = new PixelmonModelRenderer(this, 98, 49);
		tail_3.addBox(-2.5F, 1.266667F, 5.066667F, 5, 5, 4);
		tail_3.setTextureSize(128, 64);
		tail_3.mirror = true;
		setRotation(tail_3, 1.32645F, 0F, 0F);
		PixelmonModelRenderer tail_tip = new PixelmonModelRenderer(this, 98, 33);
		tail_tip.addBox(4.166667F, -0.4666667F, 6F, 1, 7, 7);
		tail_tip.setTextureSize(128, 64);
		tail_tip.mirror = true;
		setRotation(tail_tip, 1.413717F, -0.5585054F, -0.0698132F);
		Tail.addChild(tail_main);
		Tail.addChild(tail_1);
		Tail.addChild(tail_sides);
		Tail.addChild(tail_sides_2);
