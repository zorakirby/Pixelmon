...
public class ModelSceptile extends PixelmonModelBase {
	...
	public ModelSceptile() {
		...
		ModuleArm leftArm = new ModuleArm(Larm, EnumArm.Left, EnumRotation.x, 0.8F,
				legspeed);
		ModuleArm rightArm = new ModuleArm(Rarm, EnumArm.Right, EnumRotation.x, 0.8F,
				legspeed);
