...
public class ModelMetagross extends PixelmonModelBase {
	...
	public ModelMetagross() {
		...
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/metagross/Body.obj")));
		FLLeg = new PixelmonModelRenderer(this, 0, 0);
		FLLeg.setRotationPoint(4.825F, 6.882F, 3.231F);
		FLLeg.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/metagross/FrontLeftLeg.obj")));
		FRLeg = new PixelmonModelRenderer(this, 0, 0);
		FRLeg.setRotationPoint(-4.825F, 6.882F, 3.231F);
		FRLeg.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/metagross/FrontRightLeg.obj")));
		BLLeg = new PixelmonModelRenderer(this, 0, 0);
		BLLeg.setRotationPoint(4.555F, 6.882F, -4.079F);
		BLLeg.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/metagross/BackLeftLeg.obj")));
		BRLeg = new PixelmonModelRenderer(this, 0, 0);
		BRLeg.setRotationPoint(-4.555F, 6.882F, -4.079F);
		BRLeg.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/metagross/BackRightLeg.obj")));
		Body.addChild(FLLeg);
		Body.addChild(FRLeg);
		Body.addChild(BLLeg);
		Body.addChild(BRLeg);
