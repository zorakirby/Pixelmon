...
public class ModelFlygon extends PixelmonModelBase {
	...
	public ModelFlygon() {
		...
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/flygon/flying/Body.obj")));

		LWing = new PixelmonModelRenderer(this, 0, 0);
		LWing.setRotationPoint(4.0F, 6.943F, 0.056F);
		LWing.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/flygon/flying/LeftWing.obj")));

		RWing = new PixelmonModelRenderer(this, 0, 0);
		RWing.setRotationPoint(4.0F, 6.943F, -0.053F);
		RWing.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/flygon/flying/RightWing.obj")));
		Body.addChild(LWing);
		Body.addChild(RWing);
