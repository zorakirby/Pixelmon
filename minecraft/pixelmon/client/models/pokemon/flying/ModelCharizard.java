...
public class ModelCharizard extends PixelmonModelBase {
	...
	public ModelCharizard() {
		...
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/Body.obj")));

		RWing1 = new PixelmonModelRenderer(this, 0, 0);
		RWing1.setRotationPoint(-0.32247F, 2.80846F, -0.51372F);
		RWing1.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/RightWing1.obj")));
		
		RWing2 = new PixelmonModelRenderer(this, 0, 0);
		RWing2.setRotationPoint(-0.79549F, .944F, -.21F);
		RWing2.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/RightWing2.obj")));

		RWing3 = new PixelmonModelRenderer(this, 0, 0);
		RWing3.setRotationPoint(-1.1F, .79F, -.23F);
		RWing3.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/RightWing3.obj")));

		RWing4 = new PixelmonModelRenderer(this, 0, 0);
		RWing4.setRotationPoint(-.78F, .447F, -.189F);
		RWing4.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/RightWing4.obj")));

		LWing1 = new PixelmonModelRenderer(this, 0, 0);
		LWing1.setRotationPoint(0.32247F, 2.80846F, -0.51372F);
		LWing1.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/LeftWing1.obj")));

		LWing2 = new PixelmonModelRenderer(this, 0, 0);
		LWing2.setRotationPoint(0.73F, 1F, -.1F);
		LWing2.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/LeftWing2.obj")));

		LWing3 = new PixelmonModelRenderer(this, 0, 0);
		LWing3.setRotationPoint(1.1F, .79F, -.23F);
		LWing3.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/LeftWing3.obj")));

		LWing4 = new PixelmonModelRenderer(this, 0, 0);
		LWing4.setRotationPoint(.83F, .447F, -.189F);
		LWing4.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/LeftWing4.obj")));
