...
public class ModelCharizard extends PixelmonModelBase {
	...
	public ModelCharizard() {
		...
		LWing.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/LeftWing.obj")));

		RWing = new PixelmonModelRenderer(this, 0, 0);
		RWing.setRotationPoint(-0.32F, 2.813F, -0.495F);
		RWing.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/charizard/flying/RightWing.obj")));
		Body.addChild(LWing);
		Body.addChild(RWing);
