...
public class ModelMudkip extends PixelmonModelBase {
	...
	public ModelMudkip() {
		...
		Body.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/Body.obj")));
		
		footFL = new PixelmonModelRenderer(this, 0, 0);
		footFL.setRotationPoint(0.30777F, -0.206F, 0.549F);
		footFL.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/FrontLeft.obj")));
		
		footFR = new PixelmonModelRenderer(this, 0, 0);
		footFR.setRotationPoint(-0.30777F, -0.206F, 0.549F);
		footFR.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/FrontRight.obj")));
		
		footBL = new PixelmonModelRenderer(this, 0, 0);
		footBL.setRotationPoint(0.348F, -0.213F, 0.534F);
		footBL.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/BackLeft.obj")));
		
		footBR = new PixelmonModelRenderer(this, 0, 0);
		footBR.setRotationPoint(-0.348F, -0.213F, 0.534F);
		footBR.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/BackRight.obj")));
		
		head = new PixelmonModelRenderer(this, 0, 0);
		head.setRotationPoint(0F, 0.08F, .55F);
		head.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/Head.obj")));
		
		Tail = new PixelmonModelRenderer(this, 0, 0);
		Tail.setRotationPoint(0F, 0.045F, 0.835F);
		Tail.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/mudkip/Tail.obj")));
		Body.addChild(head);
