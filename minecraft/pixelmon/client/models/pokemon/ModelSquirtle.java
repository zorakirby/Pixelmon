...
public class ModelSquirtle extends PixelmonModelBase {
        ...
        public ModelSquirtle() {
                ...
                PixelmonModelRenderer HeadPiece = new PixelmonModelRenderer(this, "Head");
...
//              Tail_Mid.setRotationPoint(0F, 21F, 2F);
                ...
                skeleton = new SkeletonBiped(Body, new ModuleHead(HeadPiece), Arm_Left, Arm_Right, Leg_Left, Leg_Right);
        }
