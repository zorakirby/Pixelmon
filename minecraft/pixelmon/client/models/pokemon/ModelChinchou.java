...
public class ModelChinchou extends PixelmonModelBase
{
    ...
    public ModelChinchou()
    {
        ...
        footR.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chinchou/ModelChinchouRightLeg.obj"), 0, 0, 0));
        footR.setRotationPoint(-0.4F, 0.249F, 0.283F);
        ArmL = new PixelmonModelRenderer(this, 0, 0);
        ArmL.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chinchou/ModelChinchouLeftFin.obj"), 0, 0, 0));
        ArmL.setRotationPoint(1.278F, 0.956F, -0.03F);
        ArmR = new PixelmonModelRenderer(this, 0, 0);
        ArmR.addOBJModel(new ModelOBJWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chinchou/ModelChinchouRightFin.obj"), 0, 0, 0));
