...
public class ModelPoliwrath extends PixelmonModelBase
{
    ...
    public ModelPoliwrath()
    {
        ...
        Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathBodyCon.obj")));
        footL = new PixelmonModelRenderer(this, 0, 0);
        footL.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathLegLeftCon.obj"), 0, 0, 0 ));
        footL.setRotationPoint(8.379F, 32.515F, -8.651F);
        footR = new PixelmonModelRenderer(this, 0, 0);
        footR.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathLegRightCon.obj"), 0, 0, 0));
        footR.setRotationPoint(-8.379F, 32.515F, -8.651F);
        ArmL = new PixelmonModelRenderer(this, 0, 0);
        ArmL.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathUpperArmLeftCon.obj"), 0, 0, 0));
        ArmL.setRotationPoint(12.458F, 63.272F, -4.895F);
        ArmL2 = new PixelmonModelRenderer(this, 0, 0);
        ArmL2.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathLowerArmLeftCon.obj"), 0, 0, 0));
        ArmL2.setRotationPoint(-12.458F, -63.272F, 4.895F);
        ArmR = new PixelmonModelRenderer(this, 0, 0);
        ArmR.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathUpperArmRightCon.obj"), 0, 0, 0));
        ArmR.setRotationPoint(-12.458F, 63.272F, -4.895F);
        ArmR2 = new PixelmonModelRenderer(this, 0, 0);
        ArmR2.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/poliwrath/PoliwrathLowerArmRightCon.obj"), 0, 0, 0));
