...
public class ModelUmbreon extends PixelmonModelBase {
	// fields
	...
	public ModelUmbreon() {
		...
		PixelmonModelRenderer tail_1 = new PixelmonModelRenderer(this, 13, 22);
		tail_1.addBox(-1F, -0.8F, -1.133333F, 2, 2, 3);
		tail_1.setTextureSize(128, 64);
		tail_1.mirror = true;
		setRotation(tail_1, 0.4014257F, 0F, 0F);
		PixelmonModelRenderer tail_2 = new PixelmonModelRenderer(this, 28, 20);
		tail_2.addBox(-2F, -1.533333F, -1.133333F, 4, 4, 8);
		tail_2.setRotationPoint(0F, -1F, 2F);
		tail_2.setTextureSize(128, 64);
		tail_2.mirror = true;
		setRotation(tail_2, 0.6108652F, 0F, 0F);
		PixelmonModelRenderer tail_1_2 = new PixelmonModelRenderer(this, 10, 22);
		tail_1_2.addBox(-1F, -0.4666667F, -0.7333333F, 2, 2, 3);
		tail_1_2.setTextureSize(128, 64);
		tail_1_2.mirror = true;
		setRotation(tail_1_2, 0.1570796F, 0F, 0F);
		PixelmonModelRenderer tail_1_3 = new PixelmonModelRenderer(this, 7, 26);
		tail_1_3.addBox(-1F, -0.8F, -1.133333F, 2, 2, 3);
		tail_1_3.setTextureSize(128, 64);
		tail_1_3.mirror = true;
		setRotation(tail_1_3, 0.6457718F, 0F, 0F);
		PixelmonModelRenderer tail_3 = new PixelmonModelRenderer(this, 8, 24);
		tail_3.addBox(-1.5F, -1.466667F, -1.133333F, 3, 3, 4);
		tail_3.setRotationPoint(0F, -5F, 7F);
		tail_3.setTextureSize(128, 64);
		tail_3.mirror = true;
		setRotation(tail_3, 0.7504916F, 0F, 0F);
		PixelmonModelRenderer tail_4 = new PixelmonModelRenderer(this, 6, 23);
		tail_4.addBox(-1F, -0.8F, 1.8F, 2, 2, 3);
		tail_4.setRotationPoint(0F, -5F, 7F);
		tail_4.setTextureSize(128, 64);
		tail_4.mirror = true;
		setRotation(tail_4, 0.8901179F, 0F, 0F);
		PixelmonModelRenderer tail_5 = new PixelmonModelRenderer(this, 6, 23);
		tail_5.addBox(-0.5F, 0.2F, 3.466667F, 1, 1, 3);
		tail_5.setRotationPoint(0F, -5F, 7F);
		tail_5.setTextureSize(128, 64);
		tail_5.mirror = true;
		setRotation(tail_5, 1.029744F, 0F, 0F);
		Tail.addChild(tail_1);
		Tail.addChild(tail_2);
		Tail.addChild(tail_1_2);
		Tail.addChild(tail_1_3);
