...
public class CopyOfModelBellsprout extends ModelBase {
	// fields
	PixelmonModelRenderer Stem_1;
	PixelmonModelRenderer Stem_2;
	PixelmonModelRenderer Stem_3;
	PixelmonModelRenderer Stem_4;
	PixelmonModelRenderer Stem_5;
	PixelmonModelRenderer Stem_6;
	PixelmonModelRenderer Stem_7;
	PixelmonModelRenderer Stem_8;
	PixelmonModelRenderer Stem_9;
	PixelmonModelRenderer Stem_10;
	PixelmonModelRenderer Stem_11;
	PixelmonModelRenderer Leaf_L;
	PixelmonModelRenderer Leaf_R;
	PixelmonModelRenderer EyeL;
	PixelmonModelRenderer EyeR;
	PixelmonModelRenderer HeadTip;
	PixelmonModelRenderer HeadTop;
	PixelmonModelRenderer Head2;
	PixelmonModelRenderer Head1;
	PixelmonModelRenderer HeadMain;
	PixelmonModelRenderer MouthUpper;
	PixelmonModelRenderer Lip1;
	PixelmonModelRenderer Lip2;
	PixelmonModelRenderer Lip3;
	PixelmonModelRenderer Lip4;
	PixelmonModelRenderer RootR1;
	PixelmonModelRenderer RootR2;
	PixelmonModelRenderer AnkleR;
	PixelmonModelRenderer RootL1;
	PixelmonModelRenderer RootL2;
	PixelmonModelRenderer AnkleL;
	PixelmonModelRenderer FootR;
	PixelmonModelRenderer FootL;
	PixelmonModelRenderer StemBase;
	PixelmonModelRenderer StemPiece1;
	PixelmonModelRenderer StemPiece2;
	PixelmonModelRenderer StemPiece3;
	PixelmonModelRenderer StemHead;

	public CopyOfModelBellsprout() {
		textureWidth = 128;
		textureHeight = 128;
		setTextureOffset("StemBase.DeleteMe1", 0, 0);

		Stem_11 = new PixelmonModelRenderer(this, 49, 6);
		...
		RootR1 = new PixelmonModelRenderer(this, 49, 69);
		...
		RootR2 = new PixelmonModelRenderer(this, 50, 74);
		...
		AnkleR = new PixelmonModelRenderer(this, 53, 85);
		...
		RootL2 = new PixelmonModelRenderer(this, 50, 79);
		...
		StemBase = new PixelmonModelRenderer(this, "StemBase");
		StemBase.setRotationPoint(1F, 11.2F, 2.4F);
		setRotation(StemBase, 0F, 0F, 0F);
		StemBase.mirror = true;
		Stem_10 = new PixelmonModelRenderer(this, 49, 11);
		...
		Stem_9 = new PixelmonModelRenderer(this, 49, 17);
		...
		StemPiece1 = new PixelmonModelRenderer(this, "StemPiece1");
		StemPiece1.setRotationPoint(0F, -6.7F, 2.1F);
		setRotation(StemPiece1, 0F, 0F, 0F);
		StemPiece1.mirror = true;
		Stem_8 = new PixelmonModelRenderer(this, 49, 23);
		...
		Stem_7 = new PixelmonModelRenderer(this, 49, 29);
		...
		StemPiece2 = new PixelmonModelRenderer(this, "StemPiece2");
		StemPiece2.setRotationPoint(0F, -9.5F, 2.1F);
		setRotation(StemPiece2, 0F, 0F, 0F);
		StemPiece2.mirror = true;
		Stem_6 = new PixelmonModelRenderer(this, 49, 36);
		...
		Stem_5 = new PixelmonModelRenderer(this, 49, 42);
		...
		Leaf_L = new PixelmonModelRenderer(this, 66, 57);
		...
		Leaf_R = new PixelmonModelRenderer(this, 65, 77);
		...
		StemPiece3 = new PixelmonModelRenderer(this, "StemPiece3");
		StemPiece3.setRotationPoint(0F, -8F, -0.1F);
		setRotation(StemPiece3, 0F, 0F, 0F);
		StemPiece3.mirror = true;
		Stem_4 = new PixelmonModelRenderer(this, 49, 48);
		...
		Stem_3 = new PixelmonModelRenderer(this, 49, 54);
		...
		StemHead = new PixelmonModelRenderer(this, "StemHead");
		StemHead.setRotationPoint(1F, -8.5F, -2.1F);
		setRotation(StemHead, 0F, 0F, 0F);
		StemHead.mirror = true;
		Stem_2 = new PixelmonModelRenderer(this, 49, 59);
		...
		EyeL = new PixelmonModelRenderer(this, 41, 32);
		...
		EyeR = new PixelmonModelRenderer(this, 40, 36);
		...
		HeadTip = new PixelmonModelRenderer(this, 3, 2);
		...
		HeadTop = new PixelmonModelRenderer(this, 3, 2);
		...
		Head2 = new PixelmonModelRenderer(this, 1, 54);
		...
		Head1 = new PixelmonModelRenderer(this, 18, 53);
		...
		HeadMain = new PixelmonModelRenderer(this, 0, 91);
		...
		MouthUpper = new PixelmonModelRenderer(this, 1, 110);
		...
		Lip1 = new PixelmonModelRenderer(this, 44, 94);
		...
		Lip2 = new PixelmonModelRenderer(this, 43, 113);
		...
		Lip3 = new PixelmonModelRenderer(this, 48, 100);
		...
		Lip4 = new PixelmonModelRenderer(this, 48, 107);
