...
public class ModelTurtwig extends PixelmonModelBase {
	...
	public ModelTurtwig() {
		...
		Body.addOBJModel(new ModelOBJWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/turtwig/TurtwigBody.obj")));
		...
		footFL.addOBJModel(new ModelOBJWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/turtwig/TurtwigFrontLeftLeg.obj")));
		...
		footFR.addOBJModel(new ModelOBJWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/turtwig/TurtwigFrontRightLeg.obj")));
		...
		footBL.addOBJModel(new ModelOBJWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/turtwig/TurtwigBackLeftLeg.obj")));
