...
public class ModelMetang extends PixelmonModelBase {
	...
	public ModelMetang() {
		...
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/Metang/Body.obj")));
		LeftArm = new PixelmonModelRenderer(this, 0, 0);
		LeftArm.setRotationPoint(2.734F, 3.658F, 1.274F);
		LeftArm.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/Metang/LeftArm.obj")));
		RightArm = new PixelmonModelRenderer(this, 0, 0);
		RightArm.setRotationPoint(-2.734F, 3.658F, 1.274F);
		RightArm.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/Metang/RightArm.obj")));
		LeftHand = new PixelmonModelRenderer(this, 0, 0);
		LeftHand.setRotationPoint(4.415F, 4.040F, 1.346F);
		LeftHand.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/Metang/LeftHand.obj")));
		RightHand = new PixelmonModelRenderer(this, 0, 0);
		RightHand.setRotationPoint(-4.415f, 4.040f, 1.346f);
		RightHand.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/Metang/RightHand.obj")));
