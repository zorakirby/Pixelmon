...
public class ModelWartortle extends PixelmonModelBase {
	// fields
	...
	public ModelWartortle() {
		...
		head.setRotationPoint(-.02F, 2.3F, 0.4F);
		head.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/wartortle/Head.obj")));

		Larm = new PixelmonModelRenderer(this, 0, 0);
		Larm.setRotationPoint(0.57F, 2.3F, 0.23F);
		Larm.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/wartortle/LeftArm.obj")));

		Rarm = new PixelmonModelRenderer(this, 0, 0);
		Rarm.setRotationPoint(-0.57F, 2.3F, 0.23F);
		Rarm.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/wartortle/RightArm.obj")));
		...
		RLeg.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/wartortle/RightLeg.obj")));

		tail = new PixelmonModelRenderer(this, 0, 0);
		tail.setRotationPoint(0F, 0.737F, -0.65F);
		tail.addCustomModel(new ModelCustomWrapper(
				AdvancedModelLoader
						.loadModel("/pixelmon/client/models/objFiles/wartortle/Tail.obj")));
		...
		ModuleArm leftArm = new ModuleArm(Larm, EnumArm.Left, 0.2F, 0.3F,
				legspeed);
		ModuleArm rightArm = new ModuleArm(Rarm, EnumArm.Right, 0.2F, 0.3F,
				legspeed);
