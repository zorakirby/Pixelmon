...
public class ModelChikorita extends PixelmonModelBase {
	...
	public ModelChikorita() {
		...
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/Body.obj")));
		footFL = new PixelmonModelRenderer(this, 0, 0);
		footFL.setRotationPoint(0.4F, 0.6F, 0F);
		footFL.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/FrontLeftLeg.obj")));
		footFR = new PixelmonModelRenderer(this, 0, 0);
		footFR.setRotationPoint(-0.44F, 0.6F, 0F);
		footFR.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/FrontRightLeg.obj")));
		footBL = new PixelmonModelRenderer(this, 0, 0);
		footBL.setRotationPoint(0.276F, 0.6F, -0.9F);
		footBL.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/BackLeftLeg.obj")));
		footBR = new PixelmonModelRenderer(this, 0, 0);
		footBR.setRotationPoint(-0.39F, 0.6F, -0.9F);
		footBR.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/BackRightLeg.obj")));
		Tail = new PixelmonModelRenderer(this, 0, 0);
		Tail.setRotationPoint(-0.03458F, 1.015F, -1.24F);
		Tail.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/Tail.obj")));
		leaf = new PixelmonModelRenderer(this, 0, 0);
		leaf.setRotationPoint(0F, 2.06F, 0.5F);
		leaf.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/chikorita/Leaf.obj")));
		Body.addChild(leaf);
