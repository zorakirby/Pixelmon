...
public class ModelBeldum extends PixelmonModelBase {
	...
	public ModelBeldum() {
		...
		Body.setRotationPoint(0, 26f, 0);
		Body.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/beldum/Body.obj")));
		Head = new PixelmonModelRenderer(this, 0, 0);
		Head.setRotationPoint(-0.049F, -0.948F, 3.616F);
		Head.addCustomModel(new ModelCustomWrapper(AdvancedModelLoader.loadModel("/pixelmon/client/models/objFiles/beldum/Head.obj")));
		Body.addChild(Head);
