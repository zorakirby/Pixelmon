...
public class GuiResources {
	...
	public static ResourceLocation battleGui1 = new ResourceLocation("pixelmon:gui/battleGui1.png");
	public static ResourceLocation battleGui2 = new ResourceLocation("pixelmon:gui/battleGui2.png");
	public static ResourceLocation battleGui3 = new ResourceLocation("pixelmon:gui/battleGui3.png");
	public static ResourceLocation yesNo = new ResourceLocation("pixelmon:gui/yesNo.png");
	public static ResourceLocation chooseMove = new ResourceLocation("pixelmon:gui/chooseMove.png");
	public static ResourceLocation choosePokemon = new ResourceLocation("pixelmon:gui/choosePokemon.png");
	public static ResourceLocation selectCurrentPokemon = new ResourceLocation("pixelmon:gui/selectCurrentPokemon.png");
	public static ResourceLocation itemGui2 = new ResourceLocation("pixelmon:gui/itemGui2.png");
	public static ResourceLocation itemGui1 = new ResourceLocation("pixelmon:gui/itemGui1_Test.png");

	public static ResourceLocation pokecheckerPopup = new ResourceLocation("pixelmon:gui/pokecheckerPopup.png");
	...
	public static ResourceLocation summarySummary = new ResourceLocation("pixelmon:gui/summarySummary.png");
	public static ResourceLocation rename = new ResourceLocation("pixelmon:gui/rename.png");
	public static ResourceLocation summaryMoves = new ResourceLocation("pixelmon:gui/summaryMoves.png");
