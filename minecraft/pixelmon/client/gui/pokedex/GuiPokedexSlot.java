...
public class GuiPokedexSlot extends GuiPokedexSlotBase {
	...
	protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
		...
		// this.guiPokedex.drawString(Minecraft.getMinecraft().fontRenderer,
		// guiPokedex.pokedex.getEntry(var1).getDisplayNumber(true) + " " +
		// (String)this.guiPokedex.pokedexList.get(var1), var2+2, var3-1,
		// 16777215);
		guiPokedex.drawString(ModLoader.getMinecraftInstance().fontRenderer, p.getPokedexDisplayNumber() + " "
				+ (guiPokedex.pokedex.hasSeen(var1 + 1) || Minecraft.getMinecraft().thePlayer.capabilities.isCreativeMode ? p.name : "???"), var2 + 2, var3 - 1, 16777215);
	}
