...
public class GastlyParticles extends ParticleEffects {
	...
	public void onUpdate() {
		...
		for (int i = 0; i < 20; i++)
			ClientProxy.spawnParticle(EnumPixelmonParticles.gastly, pixelmon.worldObj, pixelmon.posX + (double) var6 + .2F, pixelmon.posY + 1.2F + var8, pixelmon.posZ + (double) var7 + .4F, pixelmon.getIsShiny());
		for (int i = 0; i < 20; i++)
			ClientProxy.spawnParticle(EnumPixelmonParticles.gastly, pixelmon.worldObj, pixelmon.posX + (double) var62 + .2F, pixelmon.posY + 1.2F + var82, pixelmon.posZ + (double) var72 - .6F , pixelmon.getIsShiny());
	}
